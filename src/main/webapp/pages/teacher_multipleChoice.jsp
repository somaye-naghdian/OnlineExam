...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/theme/css/question.css.css" />">
...
<%--    <textarea path="answers"  name="answer" id="answer" ></textarea>--%>

    <label>Correct Answer:</label>
    <input id="correctAnswer" name="correctAnswer" placeholder="correctAnswer" required="required"/><br><br>
